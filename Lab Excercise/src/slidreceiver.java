...
int i=0, rptr=-1, nf, rws=8; String rbuf[]=new String[8]; String ch; System.out.println();
do{
...
rws-=nf; System.out.println("Acknowledgmentsent"); p.println(rptr+1);
rws+=nf;
